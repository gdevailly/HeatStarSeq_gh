             ...
             sidebarLayout(
                ...
                sidebarPanel(
                    ...
                    div(id = "widgetForLabels",
                                     sliderInput("margin", label = "Label margin (static heatmap only)", value = 20, min = 1, max = 50, step = 1),
                                     sliderInput("labCex", label = "Label size (static heatmap only)", value = 1.2, min = 0.1, max = 3, step = 0.1)
                    ),
